...
public class BttiantangProviderTest {
    @Autowired
    private BttiantangProvider provider;
    ...
    public void testSearchShow() throws UnsupportedEncodingException {
        List<Show> showList = meijuttProvider.searchShows("Grey's Anatomy", new JProgressBar(), 1);
